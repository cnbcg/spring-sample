...
public class ViewOrderXmlIntegrationTest {
	...
	public void thatViewOrderRendersXMLCorrectly() throws Exception {
		...
		this.mockMvc.perform(get("/aggregators/orders/{id}", key.toString()).accept(MediaType.TEXT_XML)).andDo(print())
				.andExpect(content().contentType(MediaType.TEXT_XML)).andExpect(xpath("/order/key").string(key.toString()));
	}
