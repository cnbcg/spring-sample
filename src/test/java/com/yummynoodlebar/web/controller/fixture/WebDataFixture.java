...
public class WebDataFixture {
	...
	public static OrderStatusDetails standardOrderStatusDetails(UUID orderId) {
		return new OrderStatusDetails(orderId, UUID.randomUUID(), ORDER_NAME, new Date(), STATUS_RECEIVED);
	}
	...
	public static MenuItem standardWebMenuItem () {
		return MenuItem.fromMenuDetails(standardMenuItemDetails(STANDARD));
	}
